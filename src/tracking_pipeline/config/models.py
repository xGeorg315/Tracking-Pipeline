...
class OutputConfig:
    ...
    final_full_recompute: bool = True
    live_object_list_flush_interval_sec: float = 1.0
    live_artifact_flush_interval_sec: float = 2.0
    live_tracker_debug_flush_interval_sec: float = 10.0
